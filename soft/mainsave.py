...
MAX_SPEED = 255
ZMQ_PORT = 5555
VIDEO_DIR = "/home/aieye/robot_cam/videos"
count=0
cadrs=[]
...
def main():
    ...
    fps = 20.0
    frame_size = (640, 480)  # Размер кадра (можно изменить под вашу камеру)
    ...
    try:
        while count<500:
            ...
            # Отправка на Arduino
            cadrs.append(f'{count} {left_speed} {right_speed}\n')
